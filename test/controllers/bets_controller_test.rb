...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { admin_id: @bet.admin_id, buy_in: @bet.buy_in, description: @bet.description, end_date: @bet.end_date, start_date: @bet.start_date, title: @bet.title } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { admin_id: @bet.admin_id, buy_in: @bet.buy_in, description: @bet.description, end_date: @bet.end_date, start_date: @bet.start_date, title: @bet.title } }
