...
class PayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payout" do
    assert_difference('Payout.count') do
      post payouts_url, params: { payout: { amount: @payout.amount, bet_id: @payout.bet_id, rank: @payout.rank } }
    end
  ...
  test "should update payout" do
    patch payout_url(@payout), params: { payout: { amount: @payout.amount, bet_id: @payout.bet_id, rank: @payout.rank } }
